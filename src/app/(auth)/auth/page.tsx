...
import { useRouter } from "next/navigation"; // to trnas easily form page to another
        ...
        <div className="flex min-h-screen mt-7">
            <div className="w-full max-w-3xl mx-auto  flex flex-col lg: flex-row p-3">
                <div>
                    ...
                    <ChevronLeft className="text-gray-500 h-6 w-6 sm:h-8 sm:w-8 border-2 rounded-full py-2"></ChevronLeft>
                </div>
                <div>
  <h2 className='text-3xl sm:text-4xl lg:text-5xl font-bold mb-4 sm:mb-6 
  bg-gradient-to-r from-purple-600 via-pink-500 to-red-500 bg-clip-text 
  text-transparent pb-3'>
